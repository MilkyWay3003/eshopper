                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="mailto:eshopper@nayangoswami.com"><i class="fa fa-envelope"></i>eshopper@nayangoswami.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="search_box pull-right">
                        <form method="post" enctype="multipart/form-data" action="/products/search">
                            {{csrf_field()}}
